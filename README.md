...
Currently, I'm in the process of expanding its functionality to include:
- Discrete video output
- A plugin that integrates directly into OBS
- An optional voice recognition for an "autopilot" verse detection feature
